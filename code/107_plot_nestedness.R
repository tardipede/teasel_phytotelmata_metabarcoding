...
p_nest_meta <- plot_nestedness(subset_taxa(euk_dataset, Rank_6 == "Metazoa"), 
                               "nonphylo", 
                               "jaccard", 
                               "plot") + 
  ggtitle("Metazoa") + 
...
p_nest_fungi <- plot_nestedness(subset_taxa(euk_dataset, Rank_5 == "Fungi"), 
                                "nonphylo", 
                                "jaccard", 
                                "plot") + 
  ggtitle("Fungi") + 
...
prot_data <- subset_taxa(euk_dataset, 
  ...
  (Rank_5 != "Fungi") & (Rank_2 != "Chloroplastida") & (Rank_3 != "Ochrophyta")) | 
    Rank_5 == "Chromulinales") & (Rank_1 != "unclassified_Eukaryota"))

p_nest_prot <- plot_nestedness(prot_data, 
                               "nonphylo", 
                               "jaccard", 
                               "plot") + 
  ggtitle("Protists") + 
...
p_nest_bac <- plot_nestedness(bac_dataset, 
                              "nonphylo", 
                              "jaccard", 
                              "plot") + 
  ggtitle("Bacteria") + 
...
ggsave("./results/figures/plot_nestedness.pdf", 
       plot = plot_nestedness, 
       height = 7.5, 
       width = 20)
